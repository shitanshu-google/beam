...
public class MemoryMonitorTest {
  ...
  public void setup() throws IOException {
    ...
    monitor = MemoryMonitor.forTest(provider, 10, 0, false, null, localDumpFolder, 50);
  ...
  public void uploadToGcs() throws Exception {
    ...
    monitor =
        MemoryMonitor.forTest(provider, 10, 0, true, remoteFolder.getPath(), localDumpFolder, 50);
  ...
  public void uploadToGcsDisabled() throws Exception {
    monitor = MemoryMonitor.forTest(provider, 10, 0, true, null, localDumpFolder, 50);
